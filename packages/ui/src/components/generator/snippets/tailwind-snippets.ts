...
export const tailwindSnippets: Snippet[] = [
  ...
  },
  {
    label: 'btn-secondary',
    insertText:
      'inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200',
