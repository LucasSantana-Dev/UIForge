        ...
        <div className="mt-3">
          {image ? (
            <div className="relative rounded-lg border border-surface-3 overflow-hidden">
              <img src={image.previewUrl} alt="Reference" className="w-full max-h-48 object-contain bg-surface-0" />
              <div className="flex items-center justify-between px-3 py-2 bg-surface-0 border-t border-surface-3">
                ...
                <button type="button" onClick={removeImage} className="text-text-muted hover:text-red-500">
