...
export const metadata: Metadata = getMarketingPageMetadata('terms');

export default function TermsPage() {
  const webPageJsonLd = getMarketingWebPageJsonLd('terms');

  return (
    <>
      <script
        id="ld-json-terms-webpage"
        key="ld-json-terms-webpage"
      ...
      <MarketingSection className="max-w-3xl py-16 sm:py-24">
        ...
        <div className="siza-prose space-y-8">
          ...
          <section>
            ...
            <p>
              Siza is an open-source AI workspace that generates production-grade UI code. The
              Service includes the web application, desktop application, MCP tools, and associated
              APIs.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                The free tier includes limited generations per month as described on the pricing
                page
              </li>
